...
public class Minesweeper extends JPanel {
    ...
    private ImageIcon flag;     //Flag icon
    private ImageIcon happy;    //Happy face
    private ImageIcon win;      //Sunglasses guy
    private ImageIcon dead;     //X_X
    ...
    public Minesweeper() {
        ...
        flag = createImageIcon("images/flag.png", "Minesweeper Flag"); //http://commons.wikimedia.org/wiki/File:Minesweeper-flag.png
        happy = createImageIcon("images/happy.png", "Happy Face");     //http://www.saimasays.com/images/minesweeper.GIF
        win = createImageIcon("images/win.png", "Win Face");           //http://www.saimasays.com/images/minesweeper.GIF
        dead = createImageIcon("images/dead.png", "Dead");             //http://www.saimasays.com/images/minesweeper.GIF
    ...
    private int setSize() { //Sets the size of the board
        ...
        s = (String) JOptionPane.showInputDialog(null, "Welcome to Minesweeper!\nPlease chose a difficulty.",
                "Minesweeper", JOptionPane.PLAIN_MESSAGE, null, possibilities,
                "Medium");
        if (s.equals("Easy")) {
            size = 10;
            numMines = 15;
    ...
    public boolean floodFill(int r, int c) {  //Removes surrounding zeros
        ...
        if (r >= 0 && r <= (size - 1) && c >= 0 && c <= (size - 1)) { //Gets rid of those pesky "array out of bounds" errors
            if ((matrix[r][c] != 1 && board[r][c].isEnabled() == true && numbers[r][c] == 0) /*|| zeroNextToIt() == true*/) {
                floodFillUsed = true;  //above checks to see if the cell is not a mine, is actually enabled, and proximity count is 0.
    ...
    //Code provided by Oracle, although it's common code. Just thought I'd put it in...
...
/*************************************************
*  To-do:                                        *
*  1) Add high score tracker                     *
*  2) Change starting dialog to radio buttons    *
*  3) Format comments for javadocs               *
*  4) Fix form fill to show surrounding numbers  *
